...
class PythonLexer(RegexLexer):
    ...
    aliases = ['python', 'py', 'sage', 'python', 'py3', 'bazel', 'starlark']
    filenames = [
        '*.py',
        '*.pyw',
        # Type stubs
...
class PythonConsoleLexer(DelegatingLexer):
    ...
    def __init__(self, **options):
        python = get_bool_opt(options, 'python', True)
        if python:
            pylexer = PythonLexer
...
class PythonTracebackLexer(RegexLexer):
    ...
    .. versionchanged:: 2.5
       ...
       as the alias ``pythonTracebackLexer``.
    """

    name = 'Python Traceback'
    aliases = ['pytb', 'py3tb']
    filenames = ['*.pytb', '*.py3tb']
    mimetypes = ['text/x-python-traceback', 'text/x-python-traceback']
    url = 'https://python.org'
    version_added = '1.0'
...
pythonTracebackLexer = PythonTracebackLexer
