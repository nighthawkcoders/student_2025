...
def parse_qs_bytes(
    ...
    Keys still become type str (interpreted as latin1 in python!)
    because it's too painful to keep them as byte strings in
    python and in practice they're nearly always ascii anyway.
    """
    # This is gross, but python doesn't give us another way.
